...
Float_t Q2_centroids[3][3] = {{1.15,1.52,2.29},
			      {1.16,1.52,2.28},
			      {1.16,1.52,2.29}};
...
void MACRO_Ptbroadening_Q2_Integrated_BinCentroid()
{
...
void set_X_shift_and_centroid(TGraphErrors* g, Double_t shift, Int_t TargIndex)
{
  ...
  for(Int_t point = 0; point < N_Q2 ; point++)
    {
      g->SetPoint(point, Q2_centroids[TargIndex][point] + shift , content_Y[point]);
    }
}
